...
- (void)getDatasWithParams:(NSInteger)page {
    //http://127.0.0.1:8888/page/getPageInfoByFollow?token=aef44ddfbed1168480951c93984e84d1&page=1&rows=10

    NSDictionary *dict = @{@"page":@(page),@"rows":@10};
    [SVProgressHUD show];
    [AFNetworkingManager requestGetUrlString:@"page/getPageInfoByFollow" parameters:dict successBlock:^(id  _Nonnull responseObject) {
